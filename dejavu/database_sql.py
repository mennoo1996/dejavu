...
class SQLDatabase(Database):
    ...
    CREATE_SONGS_TABLE = """
        ...
        SONGS_TABLENAME, Database.FIELD_SONG_ID, Database.FIELD_SONGNAME, Database.FIELD_SONGARTIST, FIELD_FINGERPRINTED,
    ...
    """ % (Database.FIELD_SONGNAME, Database.FIELD_SONGARTIST, Database.FIELD_FILE_SHA1, Database.FIELD_FILE_SHA1, SONGS_TABLENAME, Database.FIELD_SONG_ID)
    ...
    """ % (Database.FIELD_SONG_ID, Database.FIELD_SONGNAME, Database.FIELD_SONGARTIST, Database.FIELD_FILE_SHA1, Database.FIELD_FILE_SHA1,
    ...
    def insert_song(self, songname, songartist, file_hash):
        ...
        """
        with self.cursor() as cur:
            cur.execute(self.INSERT_SONG, (songname, songartist, file_hash))
